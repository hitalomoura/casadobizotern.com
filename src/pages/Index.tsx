  ...
  return (
    <main className="pt-20">
      ...
      <section className="relative min-h-[90vh] flex items-center">
        ...
        <img src={logo} alt="" className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] md:w-[700px] max-w-[80%] opacity-10 pointer-events-none select-none" />
